...
<head>
  ...
  <title>Paiement des frais de reprise cloturée</title>
...
<body>
  ...
  <i class="bi bi-x-circle text-danger popup-icon"></i>
    <p style="color:black" class = "content">
      Les inscriptions pour les cas de reprise sont cloturées. Veuillez réessayer plus tard    </p>
...
<body>
  <div class="popup-content" id="popup">
    ...
    <p style="color: #333; font-family: Arial, sans-serif; font-size: 20px;">
      Le paiement des frais de reprise est cloturé. Veuillez réessayer plus tard    </p>
    <button class="popup-button" onclick="window.location.href='{{ route('index_redirect')}}'">OK</button>
  </div>
