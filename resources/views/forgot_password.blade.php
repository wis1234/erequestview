...
<head>
  ...
  <title>Demande de code de réinitialisation</title>
        ...
        <div class="service-title">
          ...
          <div id="popup-text" style="font-size: 20px; font-weight:bold; text-transform:uppercase"></div>  
            ...
            <div class="small-title">
                Code de réinitialisation de mot de passe<br><br>
                <p style="font-weight: 100; color:black">Veuillez renseigner l'email utilisé
      ...
      <div class="service-container">
        <div class="service-title">
          ...
          <div id="popup-text" style="font-size: 20px; font-weight:bold; text-transform:uppercase"></div>  
            ...
            <div class="small-title">
                Code de réinitialisation de passe<br><br>
                <p style="font-weight: 100; color:black">Veuillez renseigner l'email utilisé
                  lors de la création de votre compte <strong>e-Request</strong>.<br>
