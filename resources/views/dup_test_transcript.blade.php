...
<head>
  ...
  <title>Payement de frais de demand de duplicata de bulletin</title>
...
<body>
  <div class="popup-content" id="popup">
    ...
    <p style="color: #333; font-family: Arial, sans-serif; font-size: 20px;">
      En cliquant sur PAYER vous accepter les termes de paiement des frais de demande de duplicata de bulletin.  <!-- Vous pouvez désormais vous <a href="login.html" style="color: #333; font-weight: bold;">connecter</a> avec votre Nouveau
      mot de passe -->
    </p>
