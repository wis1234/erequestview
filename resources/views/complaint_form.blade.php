...
@keyframes spin {
  ...
  .btn-responsive {
    width: 100%; /* Largeur du bouton de 100% pour remplir toute la largeur disponible */
      ...
      <form action="{{ route('complaint_send')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-4 form-container form-step" id="step2">
          <fieldset>
            ...
            <div class="form-group">
              <label for="ecue_sub">Unité d'Enseignement:</label>
              <select id="ecue_sub" class="form-control" name="ecue_sub">
                <optgroup label="Veuillez sélectionner l'UE concernée">
            ...
            <div class="text-center">
              ...
              <button type="button" onclick="nextStep(3)" class="btn btn-primary" style="width: 80px">Suivant</button>
            </div>
          </fieldset>
        </div>
        ...
        <div class="col-lg-4 form-container form-step" id="step3">
          ...
          <fieldset>
            ...
            <div class="text-center">
              ...
              <button type="button" onclick="nextStep(4)" class="btn btn-primary" style="width: 80px">Suivant</button>
            </div>
          </fieldset>
        </div>
