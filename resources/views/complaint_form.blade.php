...
<main id="main">
  ...
  <section id="registration-form" class="registration-form">
    <div class="container">
      ...
      <form action="{{ route('complaint_send')}}" method="post" enctype="multipart/form-data">
        @csrf
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <select id="ac_level" class="form-control" name="ac_level">
                  {{-- <option value="">Veuillez sélectionner votre année d'étude</option> --}}
            ...
            <div class="form-group" id="fieldGroup">
              ...
              <select id="field" class="form-control" name="field" onchange="updatePrograms()">
                 <optgroup label="Filières">
                 <option value="TC">Veuillez sélectionner votre filière</option>
        ...
        <div class="form-container form-step" id="step2">
          <fieldset>
            <div class="form-group text-center">
              <p style="font-weight: bolder">INFORMATIONS DE RECLAMATION</p>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="complain_type" id="complain_type" onchange="toggleGradeGroup()">
                <option value="">Veuillez sélectionner le motif de réclamation</option>
            ...
            <div class="form-group">
              <label for="ues">Unité d'Enseignement:</label>
              <fieldset>
                <select id="ues" disabled name="ue">
                  <option value="" class="form-control">Veuillez sélectionner une UE</option>
              </select>
              </fieldset>
        ...
        <div class="form-container form-step" id="step3">
          <fieldset>
            ...
            <div class="form-group" id = "pv">
              ...
              <input type="text" class="form-control" id="seq_number" name="seq_number" default="undefined"  rows="1" placeholder="Ex: 15435" maxlength="8"></input>
            </div>
              ...
              <div class="form-group" id = "coefGrade">
...
<script>
  //hide or display grade group field
  function toggleGradeGroup() {
    var pv = document.getElementById("pv");
    var grade = document.getElementById("grade");
    var coefGrade = document.getElementById("coefGrade");
    var validationGroup = document.getElementById("validationGroup");
    var Reason = document.getElementById("complain_type");

    if (Reason.value === "Contestation de note") {
      pv.classList.remove("hidden");
      grade.classList.remove("hidden");
      coefGrade.classList.remove("hidden");
      validationGroup.classList.remove("hidden");
    } else {
      pv.classList.add("hidden");
      grade.classList.add("hidden");
      coefGrade.classList.add("hidden");
      validationGroup.classList.add("hidden");
    }
  }
      // Initially grade group fields
      document.addEventListener("DOMContentLoaded", function() {
    var pv = document.getElementById("pv");
    var grade = document.getElementById("grade");
    var coefGrade = document.getElementById("coefGrade");
...
<script>
  ...
  var ecue = document.getElementById('ecues').value;
  var grade_over_20 = document.getElementById('grade_over_20').value;
  var jury = document.getElementById('jury').value;
  var coef_grade = document.getElementById('coef_grade').value;
  ...
  var summary = `
    ...
    <p style="color:black"><strong>Unité d'Enseignement:</strong> ${ue}</p>
    <p style="color:black"><strong>Elément Constitutif d'Unité d'Enseignement:</strong> ${ecue}</p>
    <p style="color:black"><strong>Note sur 20:</strong> ${grade_over_20}</p>
    <p style="color:black"><strong>Note coefficiée:</strong> ${coef_grade}</p>
    <p style="color:black"><strong>Numéro séquentiel:</strong> ${seq_number}</p>
    <p style="color:black"><strong>N° de Jury:</strong> ${jury}</p>
    <p style="color:black"><strong>Validation:</strong> ${validation}</p>
