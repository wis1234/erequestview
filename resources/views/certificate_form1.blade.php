<<<<<<< HEAD:resources/views/certificate_form1.blade.php
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <title>Demande d'attestation de succès</title>
              ...
              <div class="form-group">
                ...
                <select id="ac_level" class="form-control" name="ac_level">
                  <optgroup label="Veuillez sélectionner votre année d'étude">
                    ...
                    <option value="Licence 3">Licence</option>
...
>>>>>>> 0f197e5e6821d6a3ae420e25197a08a25e64ae1c:resources/views/certificate_form_master.blade copy.php
