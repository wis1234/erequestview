...
<head>
  ...
  <title>Processus de demande d'attestation de succès</title>
  ...
  <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/breadcrumbs-bg.jpg');">
    <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
      ...
      <ol>
          ...
          <li class="white-text">Attestation</li>
      </ol>
    ...
    <section class="sample-page">
      <div class="container">
        ...
        <p>
        POUR POUVOIR FAIRE UNE DEMANDE D'ATTESTATION VEUILLEZ PROCEDER COMME SUIT:

          <ul class="list-unstyled">
             
            <li><i class="bi bi-check2"></i> <span>Scannez (prenez une photo claire) des relevé de notes de deux semestres </span></li>
            <li><i class="bi bi-check2"></i> <span> <a href="{{route('login')}}">Connectez-vous</a> à votre compte; Rassurez-vous d'en avoir créer</span></li>
            <li><i class="bi bi-check2"></i> <span>Rendez-vous dans Menu; accédez à la section SERVICES. Ensuite selectionnez ATTESTATION DE SUCCES</span></li>
          
            <li><i class="bi bi-check2"></i> <span>Remplissez soigneusement le <a href="{{route('certificate_form')}}"> formulaire</a> de demande
