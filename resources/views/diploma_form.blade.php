  ...
  <main id="main">
    ...
    <section id="registration-form" class="registration-form">
      <div class="container">
        ...
        <form action="{{ route('diploma')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="col-lg-4 form-container form-step" id="step2">
            <fieldset>
              ...
              <div class="text-center">
                <button type="button" onclick="prevStep(1)" class="btn btn-primary" style="width: 85px">Précédent</button>
          ...
          <div class="col-lg-4 form-container form-step" id="step3">
            <fieldset>
              ...
              <div class="text-center">
                <button type="button" onclick="prevStep(2)" class="btn btn-primary" style="width: 85px">Précédent</button>
          ...
          <div class="col-lg-4 form-container form-step" id="step4">
            <fieldset>
              ...
              <div class="text-center">
                <button type="button" onclick="prevStep(3)" class="btn btn-primary" style="width: 85px">Précédent</button>
        ...
        <div class="text-center">
          <button type="button" onclick="prevStep(4)" class="btn btn-primary" style="margin-right: 250px; width:85px">Précédent</button>
