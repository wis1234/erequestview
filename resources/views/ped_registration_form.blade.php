...
<main id="main">
  ...
  <section>
    <div class="service-container">
      <div class="service-title">
        ...
        <div style="font-size:35px; font-weight:bold; align-item:center">INSCRIPTION PEDAGOGIQUE</div>
        <div id="popup-text" style="font-size: 20px; font-weight:bold; text-transform:uppercase"></div>  
     
          <div class="small-title">
              Inscription pédagogique<br><br>
  ...
  <section id="registration-form" class="registration-form">
    <div class="container">
      ...
      <form action="{{ route('PedRegistration_send')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-container form-step" id="step2">
          <fieldset>
            <div class="form-group text-center">
              <p style="font-weight: bolder">INFORMATIONS D'INSCRIPTION</p>
            </div>
